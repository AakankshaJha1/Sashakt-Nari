            ...
            <ul class="slides">
              <li>
                ...
                <div class="flex-caption">
                    <h3>You have time?</h3> 
          <p>We have the opportunities.</p> 
        
           
                </div>
              </li>
              <li>
                <img src="<?php echo web_root; ?>plugins/home-plugins/img/slides/22.jpg" alt="" />
  ...
  <div class="container">
        <div class="row">
      <div class="col-md-12">
        <div class="aligncenter"><h2 class="aligncenter">Some of our Partners</h2><!-- Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident, doloribus omnis minus ovident, doloribus omnis minus temporibus perferendis nesciunt.. --></div>
        <br/>
      </div>
    </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6 col-sm-offset-6 col-xs-12 content">
        ...
        <div class="editContent"  style="height:100px;">
          <p> 
          &nbsp;&nbsp;We are tearing down the barriers that homemakers erect.
<br/>

          &nbsp;&nbsp; Due to the lack of actual platforms, despite the fact that they have the necessary skills in a variety of fields, they are unable to support themselves.<br/>

          &nbsp;&nbsp;This could be a major turning point in their lives because they will no longer only be responsible for household duties but will also have to work for themselves.</p>
        </div> 
      </div>
    </div><!-- /.row-->
  </div><!-- /.container -->

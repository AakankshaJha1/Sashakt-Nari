...
<head>
<meta charset="utf-8">
<title>NariEkta / <?php echo $title;?></title>
              ...
              <!--  <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+001) 123-456-789</p> -->
                <?php if (isset($_SESSION['APPLICANTID'])) { 
                    ...
                    echo ' <p class="pull-right login"><a title="View Notification(s)" href="'.web_root.'applicant/index.php?view=notification"> <i class="fa fa-bell-o"></i> <span class="label label-success">'.$notif.'</span></a> | <a title="View Message(s)" href="'.web_root.'applicant/index.php?view=message"> <i class="fa fa-envelope-o"></i> <span class="label label-success">'.$msg.'</span></a> | <a title="View Profile" href="'.web_root.'applicant/"> <i class="fa fa-user"></i>  '. $appl->FNAME. ' '.$appl->LNAME .' </a> | <a href="'.web_root.'logout.php">  <i class="fa fa-sign-out"> </i>Logout</a> </p>';
                      ...
                      <p   class="pull-right login"><a data-target="#myModal" data-toggle="modal" href=""> <i class="fa fa-lock"></i> Login/Signup </a></p>
                <?php } ?>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Sashkat Nari<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo web_root; ?>index.php?q=search-company">By Company Name</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-function">By Category</a></li>
                              <li><a href="<?php echo web_root; ?>index.php?q=search-jobtitle">By Job Title</a></li>
                     ...
                     <!--   <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='About'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=About">About Us</a></li> -->
                        ...
                        <!--  <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='Login'){ echo 'active'; }else{ echo ''; }}  ?>"><a href="<?php echo web_root; ?>index.php?q=login">Login</a></li> -->
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          IGDTUW <br>
          Kashmere Gate, Delhi</address>
          <p>
            <i class="icon-phone"></i> (+91) 9873645273 <br>
            <i class="icon-envelope-alt"></i> nariekta@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
